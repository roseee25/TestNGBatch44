...
public class C02_HandleDropdown {
    ...
    public void dropdownTesti() throws InterruptedException {
        ...
        // 1.adim:Dropdown webelementi locate edip bir degisken atiyoruz
       ...
       // 2.adim:Select class'indan bir obje olusturalim
        ...
        //Secim yapmamiza yardim eden bu 3 method void'dir dolayisiyla bize bir sey dondurmez

        select.selectByIndex(3);

        //Eger sevtigimiz option degerini yazdirmak istersek
