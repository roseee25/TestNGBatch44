...
public class C02_WindowsHandle {
    ...
    public void windowHandleTest() {
        ...
        // soruda window handle degerini bilmedigim bir window aciliyor 0 sayfanin window handle degerini bulmak icin
        // gectigim sayfalardaki window handle degerlerini kaydetmeliyim
        ...
        // once tun handle degerlerini alip bir set'e koyalim
        ...
        softAssert.assertEquals(driver.getTitle(),"New Window","yeni sayfa title'i isteneden farkli");
        //● Sayfadaki textin “New Window” olduğunu doğrulayın.
        WebElement ikinciSayfadakiYaziElementi=driver.findElement(By.tagName("h3"));
        softAssert.assertEquals(ikinciSayfadakiYaziElementi.getText(),"New Window","ikinci sayfadaki yazi isteneden farkli");
